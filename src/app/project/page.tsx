...
const Project = () => {
  ...
  return (
    <>
      <div className="flex flex-col justify-between md:px-24 px-6 gap-12 w-full my-12">
        <div className="flex flex-col md:flex-row items-center gap-6 justify-between">
          ...
          <div className="flex flex-col md:flex-col gap-4 items-center md:w-1/3 max-w-2xl w-full">
            ...
            />
            <select className="w-full relative max-w-xl  bg-white dark:bg-zinc-800 h-12 rounded-full overflow-hidden shadow-[0px_2px_3px_-1px_rgba(0,0,0,0.1),_0px_1px_0px_0px_rgba(25,28,33,0.02),_0px_0px_0px_1px_rgba(25,28,33,0.08)] transition duration-200 self-end dark:text-zinc-500 text-sm sm:text-base font-normal text-neutral-500 pl-4 sm:pl-12 text-left  truncate" onChange={handleOnChangeType}>
              <option selected value="" className="">Select Type</option>
      ...
      :search.length>0 && filteredProjects.length>0 && type !== "" ? <h1 className="relative text-l font-normal -my-2">
        Showing all results for  &quot;{type}&quot; with keyword &quot;{search}&quot;
      </h1>
      :null
        }
